    ...
    <header className="header">
      ...
      <nav className="menu">
        <div className='menuList'>
          <ul>
            {/* <li className={activePage === '/home' ? 'active' : 'inactive'}>
              <Link to="/home"><span className="menu-link-text">Inicio</span></Link>
            </li> */}
            <li className={activePage === '/home' ? 'active' : 'inactive'}>
              <Link to="/home"><span className={activePage === '/home' ? 'active' : "menu-link-text"}>Inicio</span></Link>
            </li>
            ...
            <li className={activePage === '/contactanos' ? 'active' : 'inactive'}>
              <Link to="/contactanos"><span className={activePage === '/contactanos' ? '' : "menu-link-text"}>Contacto</span></Link>
            </li>
            {/* <li className={activePage === '/contactanos' ? 'active' : 'inactive'}>
